import { CardWarsLobby, CardWarsProviders } from "@platform/card-wars";
import { Link, createFileRoute } from "@tanstack/react-router";

import "@platform/card-wars/styles.css";
import "@rainbow-me/rainbowkit/styles.css";

export const Route = createFileRoute("/game/card-wars/lobby")({
  component: CardWarsLobbyRoute,
});

function CardWarsLobbyRoute() {
  return (
    <CardWarsProviders>
